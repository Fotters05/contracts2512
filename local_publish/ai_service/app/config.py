...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        configured_env_file = os.getenv("AI_SERVICE_ENV_FILE")
        ...
        default_output_dir = _default_new_courses_dir()
        ...
        return cls(
            ...
            output_dir=Path(os.getenv("AI_SERVICE_OUTPUT_DIR", str(default_output_dir))),
...
def _default_new_courses_dir() -> Path:
    ...
    return documents_dir / "Новые курсы"
